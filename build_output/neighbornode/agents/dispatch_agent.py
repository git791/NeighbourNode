...
from neighbornode.skills.dispatch import check_safety_exclusion, find_nearest_available_runner, build_manifest, send_sms, queue_for_approval, retry_dispatch
...
_agent = Agent(
    ...
    tools=[check_safety_exclusion, find_nearest_available_runner, build_manifest, send_sms, queue_for_approval, retry_dispatch, log_event],
)
